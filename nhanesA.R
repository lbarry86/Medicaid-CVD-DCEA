...
# Example usage:
#nhanes_15 <- create_nhanes_data("I")  # 2015
...
# Save the dataset as an .rds file to the specified location
saveRDS(appended_nhanes_data, file = paste0(data_domain, "/appended_nhanes_data.rds"))
